...
const registration = async (req,res)=>{
    const {name,phone,email,image,password,termCondition,userType} = req.body
        ...
        const {email,password} = req.body
            ...
            const userList = async(req,res)=>{
                    ...
                    try{
                        ...
                        res.status(403).send({"message":"Unable to fatch user"})
                    }
                }
                
             

module.exports = { registration,login,userList };
